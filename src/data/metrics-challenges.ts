...
export const metricsChallenges: MetricChallenge[] = [
  ...
  // ===== VELOCITY — questões extras =====
  {
    id: "m4d",
    title: "Velocity zero em sprint de pesquisa",
    metricName: "Velocity",
    caseDescription:
      "O time dedicou uma sprint inteira a um spike de pesquisa para avaliar uma nova tecnologia crítica para o produto. A Velocity foi zero porque spikes não têm story points. O management questiona a 'sprint perdida'. O gráfico mostra a Velocity das últimas sprints.",
    chartType: "bar",
    data: [
      { label: "Sprint 1", value: 35 },
      { label: "Sprint 2", value: 38 },
      { label: "Sprint 3", value: 40 },
      { label: "Sprint 4 (spike)", value: 0 },
      { label: "Sprint 5", value: 42 },
    ],
    dataLabel: "Story Points",
    unit: "pts",
    highlight: { label: "Sprint do spike", value: "0 pts", trend: "down" },
    decisions: [
      { id: "m4dd1", text: "Atribuir story points aos spikes para manter a Velocity consistente", feedback: "Pontuar spikes infla a Velocity artificialmente e mistura tipos de trabalho diferentes. Spikes geram conhecimento, não funcionalidade entregue — são categorias distintas.", isOptimal: false },
      { id: "m4dd2", text: "Comunicar que spikes são investimentos que geram ROI futuro e mostrar o impacto da pesquisa nas sprints seguintes", feedback: "Perfeito! Spikes reduzem risco e geram conhecimento que acelera sprints futuras. Mostrar o antes/depois (ex: sprint 5 foi mais produtiva graças ao spike) demonstra o valor do investimento.", isOptimal: true },
      { id: "m4dd3", text: "Nunca mais dedicar uma sprint inteira a pesquisa — limitar spikes a 10% da capacidade", feedback: "Limitar spikes é uma boa prática geral, mas às vezes um spike de sprint inteira é necessário para decisões arquiteturais grandes. A rigidez é inimiga da boa engenharia.", isOptimal: false },
      { id: "m4dd4", text: "Misturar o spike com features normais para manter a Velocity acima de zero", feedback: "Misturar dilui o foco do spike e pode gerar resultados medianos tanto na pesquisa quanto nas features. Às vezes, dedicação total produz insights melhores.", isOptimal: false },
      { id: "m4dd5", text: "Concordar com o management que foi uma sprint improdutiva e evitar no futuro", feedback: "Aceitar a narrativa de 'sprint perdida' desvaloriza pesquisa e aprendizado. POs devem educar stakeholders sobre a importância de investimentos técnicos.", isOptimal: false },
    ],
    learningPoints: [
      "Velocity zero não significa improdutividade — spikes geram conhecimento e reduzem risco",
      "Spikes devem ter objetivos claros, critérios de sucesso e timebox definido",
      "Comunique o ROI de pesquisa mostrando como ela acelera ou melhora sprints posteriores",
      "Velocity é uma métrica de funcionalidade entregue — não mede todo tipo de trabalho valioso",
    ],
  },
  {
    id: "m4e",
    title: "Velocity cai após adicionar novo membro ao time",
    metricName: "Velocity",
    caseDescription:
      "Dois novos desenvolvedores juniores entraram no time de 4 pessoas. Nas primeiras 3 sprints, a Velocity caiu de 40 para 28 pontos porque os seniores gastam tempo com onboarding, pair programming e mentoria. O management está preocupado com a queda. O gráfico mostra a evolução.",
    chartType: "line",
    data: [
      { label: "Sprint 1", value: 40 },
      { label: "Sprint 2", value: 38 },
      { label: "Sprint 3 (onboard)", value: 30 },
      { label: "Sprint 4", value: 28 },
      { label: "Sprint 5", value: 33 },
      { label: "Sprint 6", value: 38 },
    ],
    dataLabel: "Story Points",
    unit: "pts",
    highlight: { label: "Queda pós-onboarding", value: "-30%", trend: "down" },
    decisions: [
      { id: "m4ed1", text: "Parar o pair programming para que os seniores voltem a produzir na capacidade total", feedback: "Interromper mentoria acelera métricas de curto prazo mas impede o crescimento dos juniores. Sem pair programming, juniores demoram meses a mais para serem produtivos.", isOptimal: false },
      { id: "m4ed2", text: "Explicar que a queda é temporária e esperada, mostrar a tendência de recuperação e projetar o ganho de capacidade quando os novos estiverem produtivos", feedback: "Perfeito! A queda de Velocity no onboarding é investimento em capacidade futura. Um time de 6 pessoas produtivas entregará mais que 4 no médio prazo. Use a tendência de recuperação como evidência.", isOptimal: true },
      { id: "m4ed3", text: "Atribuir aos juniores apenas tarefas simples que não precisem de mentoria", feedback: "Tarefas simples sem desafio não desenvolvem os juniores e criam uma classe de 'devs de segunda'. Desafios com suporte é como profissionais crescem.", isOptimal: false },
      { id: "m4ed4", text: "Separar os juniores em um sub-time para não impactar a Velocity principal", feedback: "Separar juniores isola-os do conhecimento do time e retarda o aprendizado. Integração total com mentoria é mais eficiente.", isOptimal: false },
      { id: "m4ed5", text: "Pedir que os juniores aprendam sozinhos com documentação para não impactar o time", feedback: "Aprendizado solo é lento e frustrante. Pair programming e mentoria ativa são 3-5x mais eficientes para onboarding técnico.", isOptimal: false },
    ],
    learningPoints: [
      "Queda de Velocity no onboarding é investimento, não perda — projetar a recuperação é papel do PO",
      "Lei de Brooks: adicionar pessoas a um projeto atrasado atrasa mais — mas para um time saudável, onboarding planejado funciona",
      "Pair programming durante onboarding é a forma mais eficiente de transferir conhecimento",
      "Velocity deve ser analisada em tendência (6+ sprints), não sprint a sprint",
    ],
  },

  // ===== BURNDOWN / BURNUP — questões extras =====
  {
    id: "m5d",
    title: "Burndown mostra itens que não são concluídos no final",
    metricName: "Burndown / Burnup",
    caseDescription:
      "Nas últimas 4 sprints, o Burndown consistentemente não chega a zero. O time planeja 30 pontos mas entrega entre 22-25. Os 5-8 pontos restantes são sempre carregados para a próxima sprint. O gráfico mostra o padrão das últimas 4 sprints.",
    chartType: "bar",
    data: [
      { label: "Sprint 7", value: 8 },
      { label: "Sprint 8", value: 6 },
      { label: "Sprint 9", value: 7 },
      { label: "Sprint 10", value: 5 },
    ],
    dataLabel: "Pontos não entregues",
    unit: "pts",
    highlight: { label: "Média não entregue", value: "6.5 pts/sprint", trend: "up" },
    decisions: [
      { id: "m5dd1", text: "Pressionar o time para entregar todos os pontos, incluindo horas extras se necessário", feedback: "Horas extras são insustentáveis e sinalizam overcommitment crônico. O problema é o planejamento, não o esforço do time.", isOptimal: false },
      { id: "m5dd2", text: "Recalibrar o planejamento usando a Velocity real (22-25 pts) em vez da desejada (30 pts) e investigar por que os itens transbordam", feedback: "Perfeito! Planejar com base na Velocity real é honestidade. Além disso, investigar os itens que transbordam (são sempre os mesmos tipos? falta refinamento? dependências?) permite resolver a causa raiz.", isOptimal: true },
      { id: "m5dd3", text: "Remover os itens não entregues do backlog no final da sprint para mostrar 100% de entrega", feedback: "Remover itens para manipular métricas é desonesto e esconde o problema real. Os itens removidos provavelmente são necessários e reaparecerão.", isOptimal: false },
      { id: "m5dd4", text: "Dividir os itens grandes em sub-itens menores para que mais sejam concluídos", feedback: "Dividir itens ajuda na fluidez, mas se o time está sistematicamente overcommitting, o problema é de capacidade planejada, não tamanho dos itens.", isOptimal: false },
      { id: "m5dd5", text: "Aumentar o tamanho da sprint de 2 para 3 semanas para dar mais tempo", feedback: "Sprints maiores não resolvem overcommitment — apenas adiam o problema. O time precisa planejar com base em dados reais, não em esperança.", isOptimal: false },
    ],
    learningPoints: [
      "Burndown que nunca chega a zero indica overcommitment crônico — recalibre o planejamento",
      "Use a Velocity das últimas 3-5 sprints como base para o próximo planning, não um número aspiracional",
      "Itens que transbordam repetidamente merecem investigação: são mal refinados, grandes demais ou têm dependências?",
      "É melhor planejar menos e entregar 100% do que planejar muito e criar frustração com 80%",
    ],
  },
  {
    id: "m5e",
    title: "Burnup revela trabalho invisível consumindo capacidade",
    metricName: "Burndown / Burnup",
    caseDescription:
      "O Burnup mostra que o time concluiu 25 pontos na sprint, mas o Burndown planejado era de apenas 20 pontos. Os 5 pontos extras são hotfixes, suporte e trabalho não-planejado que entrou durante a sprint. Paradoxalmente, stakeholders veem que só 20 pontos foram 'entregues'. O gráfico mostra o trabalho planejado vs. total realizado.",
    chartType: "stacked",
    data: [
      { label: "Sprint 6", value: 18, value2: 6 },
      { label: "Sprint 7", value: 20, value2: 5 },
      { label: "Sprint 8", value: 19, value2: 7 },
      { label: "Sprint 9", value: 20, value2: 8 },
      { label: "Sprint 10", value: 17, value2: 9 },
    ],
    dataLabel: "Planejado concluído",
    dataLabel2: "Não-planejado",
    unit: "pts",
    highlight: { label: "Trabalho não-planejado", value: "25-35% da capacidade", trend: "up" },
    decisions: [
      { id: "m5ed1", text: "Ignorar o trabalho não-planejado nas métricas — é exceção, não regra", feedback: "Se 25-35% da capacidade é consumida por trabalho não-planejado, isso é estrutural, não exceção. Ignorar distorce a visão da capacidade real.", isOptimal: false },
      { id: "m5ed2", text: "Tornar o trabalho não-planejado visível no Burnup, reservar capacidade para ele no planning e investigar como reduzi-lo", feedback: "Perfeito! Visibilidade é o primeiro passo. Reservar buffer para trabalho não-planejado (ex: 25% da capacidade) e investigar fontes (hotfixes = problemas de qualidade, suporte = falta de documentação) permite reduzir gradualmente.", isOptimal: true },
      { id: "m5ed3", text: "Recusar todo trabalho não-planejado durante a sprint", feedback: "Hotfixes urgentes e suporte crítico não podem ser recusados. A solução é planejar para eles e reduzir sua frequência, não bloqueá-los.", isOptimal: false },
      { id: "m5ed4", text: "Criar um time de suporte separado para lidar com trabalho não-planejado", feedback: "Um time separado pode ajudar, mas sem reduzir as fontes de trabalho não-planejado (bugs, falta de documentação), o time de suporte crescerá indefinidamente.", isOptimal: false },
      { id: "m5ed5", text: "Aumentar a Velocity planejada para compensar o trabalho extra", feedback: "Planejar mais para compensar não-planejado é overcommitment disfarçado. Melhor reservar capacidade explicitamente para imprevistos.", isOptimal: false },
    ],
    learningPoints: [
      "Trabalho não-planejado consome capacidade real mas frequentemente é invisível nas métricas",
      "Reserve capacidade explícita para imprevistos (tipicamente 15-25%) baseado em dados históricos",
      "Fontes de trabalho não-planejado revelam problemas sistêmicos: hotfixes = qualidade, suporte = documentação",
      "Burnup é superior ao Burndown para visualizar trabalho total realizado vs. planejado",
    ],
  },

  // ===== TAXA DE ENTREGA NO PRAZO — questões extras =====
  {
    id: "m6d",
    title: "Prazos cumpridos internamente mas não externamente",
    metricName: "Taxa de Entrega no Prazo",
    caseDescription:
      "O time entrega 90% dos itens no prazo das sprints. Porém, clientes percebem atraso porque a feature só chega a produção 2-3 sprints depois de pronta (fila de release, aprovação de compliance, deploy manual). O gráfico mostra o gap entre 'pronto no dev' e 'disponível para o cliente'.",
    chartType: "bar",
    data: [
      { label: "Feature A", value: 2, value2: 8 },
      { label: "Feature B", value: 1, value2: 6 },
      { label: "Feature C", value: 3, value2: 10 },
      { label: "Feature D", value: 2, value2: 7 },
      { label: "Feature E", value: 1, value2: 9 },
    ],
    dataLabel: "Sprints até pronto",
    dataLabel2: "Sprints até produção",
    unit: "sprints",
    highlight: { label: "Gap dev→produção", value: "2-3 sprints", trend: "up" },
    decisions: [
      { id: "m6dd1", text: "Considerar o item entregue quando o dev conclui — o resto não é responsabilidade do time", feedback: "A definição de 'entregue' que importa é quando o cliente pode usar. Se o time declara 'pronto' mas o cliente não tem acesso, é uma métrica de vaidade.", isOptimal: false },
      { id: "m6dd2", text: "Estender a Definition of Done até produção e automatizar o pipeline de release (CI/CD, aprovações paralelas, deploy contínuo)", feedback: "Perfeito! 'Done' deve significar 'em produção e disponível para o cliente'. Automatizar releases, paralelizar aprovações e eliminar filas manuais fecha o gap entre dev e produção.", isOptimal: true },
      { id: "m6dd3", text: "Fazer releases mensais grandes em vez de releases por sprint", feedback: "Releases grandes e infrequentes aumentam o risco por release e o tempo de espera. O oposto — releases pequenas e frequentes — é mais seguro e ágil.", isOptimal: false },
      { id: "m6dd4", text: "Pressionar compliance para aprovar mais rápido", feedback: "Pressionar sem oferecer soluções gera atrito. Melhor propor processos paralelos, aprovações por categoria e automação de checks de compliance.", isOptimal: false },
      { id: "m6dd5", text: "Informar aos clientes que features demoram 2-3 sprints após anúncio para estarem disponíveis", feedback: "Gerenciar expectativas é válido, mas aceitar o gap sem tentar reduzi-lo é conformismo. Automatização pode eliminar a maior parte do atraso.", isOptimal: false },
    ],
    learningPoints: [
      "'Entregue' deve significar 'em produção e disponível para o cliente' — não apenas 'código pronto'",
      "O gap entre dev e produção é frequentemente o maior componente do time-to-market",
      "CI/CD e aprovações paralelas podem reduzir o tempo de release de semanas para horas",
      "Definition of Done deve incluir deploy em produção para alinhar métricas internas com percepção do cliente",
    ],
  },
  {
    id: "m6e",
    title: "Taxa de entrega melhora mas custo de oportunidade sobe",
    metricName: "Taxa de Entrega no Prazo",
    caseDescription:
      "Para garantir 95% de entregas no prazo, o time passou a planejar apenas itens simples e conhecidos. Features inovadoras e exploratórias foram removidas do backlog por terem alto risco de atraso. A taxa de entrega está ótima, mas o produto estagnou em inovação. O gráfico mostra a distribuição dos tipos de itens entregues.",
    chartType: "stacked",
    data: [
      { label: "Sprint 1", value: 3, value2: 7 },
      { label: "Sprint 2", value: 2, value2: 8 },
      { label: "Sprint 3", value: 1, value2: 9 },
      { label: "Sprint 4", value: 1, value2: 10 },
      { label: "Sprint 5", value: 0, value2: 11 },
    ],
    dataLabel: "Inovação/Exploratório",
    dataLabel2: "Incremental/Seguro",
    unit: "itens",
    highlight: { label: "Itens inovativos", value: "0% na última sprint", trend: "down" },
    decisions: [
      { id: "m6ed1", text: "Manter o foco em entregas no prazo — inovação pode esperar", feedback: "Sem inovação, o produto perde competitividade e clientes migram para concorrentes mais modernos. A estagnação é mais perigosa que alguns atrasos.", isOptimal: false },
      { id: "m6ed2", text: "Reservar 20-30% da capacidade para itens exploratórios com expectativas de prazo diferentes e métricas de aprendizado", feedback: "Perfeito! Separar itens em categorias (build vs. explore) com métricas diferentes evita que a pressão por prazo mate a inovação. Itens exploratórios medem aprendizado, não entrega no prazo.", isOptimal: true },
      { id: "m6ed3", text: "Fazer hackathons trimestrais para compensar a falta de inovação no dia a dia", feedback: "Hackathons são complementares mas não substituem inovação contínua. Uma hackathon a cada 3 meses produz menos inovação que 20% da capacidade dedicada toda sprint.", isOptimal: false },
      { id: "m6ed4", text: "Parar de medir taxa de entrega no prazo para liberar espaço para inovação", feedback: "Abandonar a métrica perde os ganhos de previsibilidade. Melhor ter métricas diferentes por tipo de item do que eliminar métricas.", isOptimal: false },
      { id: "m6ed5", text: "Pedir que itens inovadores sejam tratados como features normais com prazo fixo", feedback: "Itens exploratórios por natureza têm alta incerteza. Forçar prazo fixo ou mata a inovação ou gera entregas superficiais. Categorias diferentes exigem métricas diferentes.", isOptimal: false },
    ],
    learningPoints: [
      "Otimizar uma métrica isoladamente pode criar efeitos colaterais nocivos — sempre monitore o equilíbrio",
      "Separar trabalho em categorias (build/explore) com métricas distintas preserva inovação e previsibilidade",
      "20-30% da capacidade dedicada a exploração é uma referência comum em times de produto saudáveis",
      "Lei de Goodhart se aplica também à taxa de entrega: quando vira meta, o time evita riscos necessários",
    ],
  },
  ...
  {
    id: "m7d",
    title: "WIP controlado mas filas de espera crescem",
    metricName: "Work in Progress (WIP)",
    caseDescription:
      "O time implementou WIP limits e o número de itens em progresso está controlado em 5. Porém, a coluna 'Pronto para Dev' acumula 15+ itens esperando. O Lead Time total continua alto porque os itens passam mais tempo em fila do que em desenvolvimento. O gráfico mostra itens por coluna do Kanban.",
    chartType: "bar",
    data: [
      { label: "Backlog", value: 30 },
      { label: "Pronto p/ Dev", value: 15 },
      { label: "Em Progresso", value: 5 },
      { label: "Code Review", value: 3 },
      { label: "Concluído", value: 8 },
    ],
    dataLabel: "Qtd de itens",
    unit: "itens",
    highlight: { label: "Fila 'Pronto p/ Dev'", value: "15 itens", trend: "up" },
    decisions: [
      { id: "m7dd1", text: "Aumentar o WIP limit para puxar mais itens da fila", feedback: "Aumentar WIP para esvaziar filas só transfere o acúmulo para dentro do processo. O resultado será mais context switching e menos foco.", isOptimal: false },
      { id: "m7dd2", text: "Aplicar WIP limits em todas as colunas do Kanban, incluindo filas de espera, e investigar se o backlog está sendo refinado em excesso ou se há gargalo na capacidade de desenvolvimento", feedback: "Perfeito! WIP limits devem ser aplicados em todo o fluxo, não apenas em 'Em Progresso'. Limitar a fila 'Pronto para Dev' a 2-3 sprints de capacidade evita acúmulo. Se a fila cresce, o upstream está produzindo mais do que o time consome.", isOptimal: true },
      { id: "m7dd3", text: "Parar de refinar itens até que a fila diminua", feedback: "Parar refinamento cria um feast/famine: a fila esvazia mas depois não há itens prontos. Melhor reduzir o ritmo de refinamento para equilibrar com a capacidade.", isOptimal: false },
      { id: "m7dd4", text: "Priorizar apenas os top 5 itens da fila e mover o resto de volta ao backlog", feedback: "Mover itens de volta ajuda pontualmente, mas sem limitar o fluxo de entrada, a fila crescerá novamente. Limites de WIP em filas são a solução sistêmica.", isOptimal: false },
      { id: "m7dd5", text: "Adicionar mais desenvolvedores para consumir a fila mais rápido", feedback: "Mais devs podem ajudar se a fila for permanente, mas se o fluxo de entrada excede a capacidade, mais devs apenas adiam o problema. Equilibre o sistema primeiro.", isOptimal: false },
    ],
    learningPoints: [
      "WIP limits devem ser aplicados em todo o fluxo (Kanban end-to-end), não apenas na coluna de desenvolvimento",
      "Filas de espera são WIP oculto que infla o Lead Time sem aparecer nas métricas tradicionais de WIP",
      "Uma fila crescente indica desequilíbrio entre a velocidade de entrada e a capacidade de processamento",
      "A fila 'Pronto para Dev' deve ter no máximo 1-2 sprints de capacidade para manter o fluxo saudável",
    ],
  },
  {
    id: "m7e",
    title: "Time resiste a WIP limits por medo de ociosidade",
    metricName: "Work in Progress (WIP)",
    caseDescription:
      "Ao propor WIP limits de 2 itens por dev, o time argumenta que ficará 'ocioso' quando bloqueado. Devs têm medo de parecer improdutivos e preferem ter 3-4 itens em paralelo para 'sempre ter algo para fazer'. O gráfico mostra como o Throughput se comporta em diferentes níveis de WIP.",
    chartType: "line",
    data: [
      { label: "WIP 1", value: 5, value2: 2 },
      { label: "WIP 2", value: 8, value2: 3 },
      { label: "WIP 3", value: 7, value2: 4 },
      { label: "WIP 4", value: 6, value2: 5 },
      { label: "WIP 5+", value: 4, value2: 6 },
    ],
    dataLabel: "Throughput (itens/semana)",
    dataLabel2: "Context switches/dia",
    unit: "itens",
    highlight: { label: "WIP ótimo", value: "2 itens/dev", trend: "neutral" },
    decisions: [
      { id: "m7ed1", text: "Permitir que cada dev escolha seu próprio WIP limit", feedback: "Sem limites consistentes, cada dev otimiza para si mas o sistema perde fluxo. WIP limits são do time, não individuais — afetam o fluxo total.", isOptimal: false },
      { id: "m7ed2", text: "Experimentar WIP limits por 2 sprints, mostrar dados de Throughput e deixar o time ajustar baseado na experiência", feedback: "Excelente! Experimentação com dados remove o medo e constrói confiança. Quando o time vê que WIP 2 produz mais Throughput que WIP 5, a resistência diminui. Ajustes baseados em experiência geram buy-in.", isOptimal: true },
      { id: "m7ed3", text: "Impor WIP limits sem discussão — é decisão do processo, não do time", feedback: "Impor sem discussão gera resistência passiva. O time pode contornar os limites (não atualizando o quadro) ou trabalhar insatisfeito. Engajamento é essencial.", isOptimal: false },
      { id: "m7ed4", text: "Desistir dos WIP limits para não gerar conflito com o time", feedback: "Evitar conflito às custas da melhoria é liderança fraca. O PO e Scrum Master devem facilitar a mudança com dados e experimentação, não ceder à resistência.", isOptimal: false },
      { id: "m7ed5", text: "Permitir WIP alto mas exigir que itens sejam concluídos antes de iniciar novos", feedback: "Essa regra é basicamente um WIP limit disfarçado — se itens precisam ser concluídos antes de iniciar, o WIP efetivo é baixo. Seja explícito sobre o limite.", isOptimal: false },
    ],
    learningPoints: [
      "Resistência a WIP limits geralmente vem do medo de parecer improdutivo — aborde com dados, não com autoridade",
      "Experimentação com timebox (2 sprints) e dados reduz resistência e constrói confiança",
      "Throughput ótimo geralmente é alcançado com WIP de 1-2 itens por dev — mais que isso reduz eficiência",
      "Ociosidade temporária é preferível a context switching crônico — o tempo 'livre' pode ser usado para ajudar colegas, refatorar ou aprender",
    ],
  },

  // ===== CONE DA INCERTEZA — questões extras =====
  {
    id: "cone-incerteza-4",
    title: "Stakeholder exige precisão impossível no início",
    metricName: "Cone da Incerteza",
    caseDescription:
      "O CFO exige uma estimativa com margem de erro de no máximo 10% para um projeto que ainda está na fase de viabilidade. O time estima entre 4 e 10 meses. O CFO diz que precisa de um número preciso para o orçamento anual. O gráfico mostra a margem de erro típica em cada fase.",
    chartType: "area",
    data: [
      { label: "Viabilidade", value: 200, value2: 50 },
      { label: "Requisitos", value: 150, value2: 67 },
      { label: "Design", value: 115, value2: 87 },
      { label: "Código 25%", value: 110, value2: 91 },
      { label: "Código 75%", value: 105, value2: 95 },
      { label: "Entrega", value: 100, value2: 100 },
    ],
    dataLabel: "Margem de Erro (%)",
    dataLabel2: "Precisão (%)",
    unit: "%",
    highlight: { label: "Precisão atual", value: "50% (viabilidade)", trend: "down" },
    decisions: [
      { id: "ci4-a", text: "Dar o número médio (7 meses) para satisfazer o CFO", feedback: "O número médio ignora a variação de 4-10 meses. Se o projeto levar 10, o CFO terá planejado mal com base em informação imprecisa apresentada como precisa.", isOptimal: false },
      { id: "ci4-b", text: "Apresentar o Cone da Incerteza ao CFO, propor um orçamento com cenários (otimista/base/pessimista) e marcos de re-estimativa", feedback: "Perfeito! Educar o CFO com o conceito visual do cone e propor cenários com probabilidades permite planejamento orçamentário realista. Marcos de re-estimativa (após design, após 25% do código) reduzem incerteza progressivamente.", isOptimal: true },
      { id: "ci4-c", text: "Usar a estimativa pessimista (10 meses) para garantir que o orçamento será suficiente", feedback: "Orçamento baseado no pior cenário pode inviabilizar o projeto se parecer caro demais. Cenários com probabilidades são mais informativos que o extremo pessimista.", isOptimal: false },
      { id: "ci4-d", text: "Pedir mais 3 meses de estudo antes de dar qualquer estimativa", feedback: "3 meses de estudo atrasam o projeto e podem não reduzir a incerteza proporcionalmente. Iterações curtas de discovery são mais eficientes.", isOptimal: false },
      { id: "ci4-e", text: "Delegar a estimativa ao tech lead e apresentar como responsabilidade técnica", feedback: "Estimar é responsabilidade compartilhada entre PO, tech lead e time. Delegar transfere pressão sem resolver o problema de incerteza.", isOptimal: false },
    ],
    learningPoints: [
      "Stakeholders financeiros precisam de cenários com probabilidades, não de números falso-precisos",
      "O Cone da Incerteza é uma ferramenta de comunicação poderosa para educar stakeholders sobre estimativas",
      "Marcos de re-estimativa (design complete, 25% código) permitem revisões orçamentárias incrementais",
      "Três cenários (otimista/base/pessimista) com probabilidades atendem a necessidade de planejamento sem prometer falsa precisão",
    ],
  },
  {
    id: "cone-incerteza-5",
    title: "Cone não estreita mesmo após meses de desenvolvimento",
    metricName: "Cone da Incerteza",
    caseDescription:
      "O projeto está no mês 4 de desenvolvimento, mas as estimativas continuam variando muito — de 3 a 8 meses restantes. Normalmente, nessa fase o cone deveria ter estreitado significativamente. Mudanças constantes de requisitos e pivots de estratégia impedem que a incerteza diminua. O gráfico mostra como o cone deveria ter evoluído vs. como realmente está.",
    chartType: "line",
    data: [
      { label: "Mês 1", value: 300, value2: 300 },
      { label: "Mês 2", value: 200, value2: 280 },
      { label: "Mês 3", value: 130, value2: 250 },
      { label: "Mês 4", value: 110, value2: 230 },
    ],
    dataLabel: "Cone esperado (%)",
    dataLabel2: "Cone real (%)",
    unit: "%",
    highlight: { label: "Cone real vs esperado", value: "230% vs 110%", trend: "up" },
    decisions: [
      { id: "ci5-a", text: "Aceitar a incerteza e continuar sem tentar estreitar o cone", feedback: "Aceitar incerteza crônica sem investigar as causas é negligência. O cone não estreita por motivos específicos que podem ser tratados.", isOptimal: false },
      { id: "ci5-b", text: "Congelar requisitos e escopo para forçar o cone a estreitar", feedback: "Congelar escopo pode estreitar o cone, mas se os requisitos estão mudando por causa do mercado, congelar o errado é pior que ter incerteza.", isOptimal: false },
      { id: "ci5-c", text: "Investigar por que os requisitos mudam tanto — falta de alinhamento estratégico, mudança de mercado ou indecisão — e tratar a causa raiz", feedback: "Perfeito! O cone não estreita quando decisões são revertidas ou requisitos mudam constantemente. Identificar se a causa é falta de visão, mudança real de mercado ou indecisão permite ação específica: alinhar visão, adaptar com disciplina ou forçar decisões.", isOptimal: true },
      { id: "ci5-d", text: "Cancelar o projeto já que a incerteza não diminui", feedback: "Cancelar pode ser necessário em casos extremos, mas antes é preciso entender por que a incerteza persiste. Se a causa for tratável, cancelar é desperdício.", isOptimal: false },
      { id: "ci5-e", text: "Adicionar mais pessoas ao projeto para avançar mais rápido e reduzir incerteza", feedback: "Mais pessoas não reduzem incerteza de requisitos — reduzem tempo de execução. Se o problema é saber o quê construir, mais braços não ajudam.", isOptimal: false },
    ],
    learningPoints: [
      "Se o cone não estreita ao longo do tempo, há problemas sistêmicos: mudanças de requisitos, falta de alinhamento ou indecisão",
      "Incerteza persistente de requisitos indica que o problema é de discovery/estratégia, não de execução",
      "Diferencie mudanças necessárias (mercado mudou) de mudanças evitáveis (indecisão, falta de visão)",
      "O PO deve escalar quando mudanças constantes de estratégia impedem a convergência do projeto",
    ],
  },
];
